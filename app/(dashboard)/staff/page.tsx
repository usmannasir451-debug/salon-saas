...
import { Users, Plus, Pencil, Trash2, Loader2, Phone, CalendarDays, UserCheck, UserX, DollarSign, Percent, FileSpreadsheet, Download, Upload, ChevronDown } from 'lucide-react'
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuTrigger } from '@/components/ui/dropdown-menu'
import { StaffBulkModal, downloadStaffTemplate, exportStaff } from '@/components/StaffBulkModal'
...
export default function StaffPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          {isOwner && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={downloadStaffTemplate}>
                  <Download className="w-3.5 h-3.5 mr-2" />
                  Download Template
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => exportStaff(staff)}>
                  <Download className="w-3.5 h-3.5 mr-2" />
                  Export Current Staff
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => setStaffBulkOpen(true)}>
      ...
      <StaffBulkModal
        open={staffBulkOpen}
        onClose={() => setStaffBulkOpen(false)}
        ownerId={ownerId}
        existingStaff={staff}
